...
// ============================================================
// TAREAS PENDIENTES — App.jsx
// ── P1 🔵 Roger · HU-01 (Autenticación — pantalla Login) ────
...
// ── P1 🔵 Roger · HU-10 (Offline — ver SolicitudesView) ─────
// ── P2 🟣 Beymar · HU-11 (Monitoreo — ver DashboardView) ────
// ============================================================
...
export default function App() {
  ...
  return (
    <div id="app" className="show">
      ...
      {/* DevTaskPanel removido del layout general — cada vista tiene el suyo */}
    </div>
  );
}
